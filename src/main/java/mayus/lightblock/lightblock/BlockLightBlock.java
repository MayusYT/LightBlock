package mayus.lightblock.lightblock;

import mayus.lightblock.LightBlock;
...
public class BlockLightBlock extends Block{
    ...
    public static final ResourceLocation LIGHT_BLOCK = new ResourceLocation(LightBlock.MODID, "lightblock");



    public BlockLightBlock() {
        super(Material.IRON);
        setCreativeTab(LightBlock.creativeTab);
        setTranslationKey("lightblock");
        setHardness(5);
